...
CREATE table dirs (
    id UUID PRIMARY KEY,
    user_id INTEGER NOT NULL REFERENCES users ON UPDATE RESTRICT ON DELETE RESTRICT,
...
CREATE table servers (
  id UUID PRIMARY KEY,
  user_id INTEGER NULL NULL REFERENCES users ON UPDATE RESTRICT ON DELETE RESTRICT,
